...
**Deskripsi:** Memulai proses autentikasi dengan Google OAuth 2.0
...
1. User diarahkan ke Google OAuth consent screen
2. User memberikan permission
3. Google redirect ke `/auth/google/callback`
4. Backend memproses dan redirect ke frontend dengan token

---

#### GET `/auth/google/callback`

**Deskripsi:** Callback endpoint untuk Google OAuth setelah user memberikan consent

**Method:** GET (Internal - called by Google)
...
**Response:** Redirect ke frontend dengan access token
...
**Response Data (dalam URL params):**
