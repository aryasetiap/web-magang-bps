...
- **Response:** Data submission yang sudah di-update.
...
- **Role:** Admin, Staff BPS
- **Response:** List submission untuk tugas tersebut.
...
- **Body:**
  ...
  ```
- **Response:** Data submission yang sudah dinilai.
...
- **Intern:**
  - Lihat tugas yang di-assign, submit/resubmit tugas, lihat status submission milik sendiri.
