    ...
    <header className="bg-white shadow-sm p-4 sticky top-0 z-50">
      <div className="container mx-auto flex justify-between items-center">
        <div className="flex items-center">
          ...
          <h1 className="text-lg md:text-xl font-bold text-bps-blue leading-tight"> {/* Tambah leading-tight dan sesuaikan ukuran teks */}
            Sistem Magang<br />
        ...
        <nav>
          <ul className="flex space-x-6">
            ...
            <li>
                <a href="/login" 
                className="border-2 border-bps-blue text-bps-blue font-semibold py-2 px-4 rounded-lg shadow-md  transition-colors duration-200">Login
                </a></li>
            <li>
                <a 
                href="/register" 
