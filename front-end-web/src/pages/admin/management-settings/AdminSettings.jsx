...
} from "@heroicons/react/24/outline"; // Untuk ikon status
...
function AdminSettingsPage() {
  ...
  const handleSubmit = (e) => {
    ...
    if (
      ...
      new Date(settings.registrationOpenDate) >
        new Date(settings.registrationCloseDate)
    ) {
      setSaveStatus("error");
      alert(
        "Tanggal buka pendaftaran tidak boleh setelah tanggal tutup pendaftaran!"
      );
      return;
    }
  ...
  return (
    <div className="bg-white p-8 rounded-lg shadow-md">
      ...
      <p className="text-gray-700 mb-6">
        Atur parameter global sistem seperti periode pendaftaran dan kuota
        peserta magang.
      </p>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="mb-6 p-6 border rounded-lg bg-blue-50">
          ...
          <p className="text-sm text-gray-600 mt-4">
            Peserta magang hanya dapat mengajukan pendaftaran dalam rentang
            tanggal ini.
          </p>
        </div>
        ...
        <div className="mb-6 p-6 border rounded-lg bg-green-50">
          ...
          <p className="text-sm text-gray-600 mt-4">
            Jumlah maksimum peserta magang yang dapat diterima dalam satu
            periode.
          </p>
        </div>
          ...
          >
            ...
            <span className="font-medium">
              {saveStatus === "success"
                ...
                : "Gagal menyimpan pengaturan. Periksa kembali input Anda."}
            </span>
          </div>
        )}
      </form>
